...
export default function () {
  return (
    ...
    <div>
      <img src="/images/items/enchanted/helm.png" alt="آیتم جادویی هلم" className="m-auto" />
      <img src="/images/items/enchanted/3.jpg" alt="نمای آیتم جادویی هلم" className="lg:w-[450px] m-auto border-6 border-red-500"/>
