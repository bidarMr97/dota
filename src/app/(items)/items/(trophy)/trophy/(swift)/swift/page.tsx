...
export default function () {
    return (
        ...
        <div>
          <img src="/images/items/trophy/swift.png" alt="جام سریع" className="m-auto"/>
          <img src="/images/items/trophy/4.jpg" alt="تصویر جام شماره چهار" className="lg:w-[450px] m-auto border-6 border-red-500"/>
